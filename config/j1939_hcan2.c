...
__weak J1939_EXTERN_FUNCTION_DEF(hcan2, MissingCallBack){
  /* User define START */
  J1939_LOG_ERROR("'hcan2' Message missing(PGN 0x%06X)", J1939_GetPGN(((J1939_Message_t)argument)->ID));
...
__weak J1939_EXTERN_FUNCTION_DEF(hcan2, TimeoutCallBack){
  /* User define START */
  J1939_LOG_ERROR("'hcan2' timeout(PGN 0x%06X)", J1939_GetPGN(((J1939_Message_t)argument)->ID));
  /* User define END */
  return J1939_OK;
};
